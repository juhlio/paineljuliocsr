...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function processaalterasenha(request $request){
        ...
        $validator = $this->validatorAlterarSenha($data);
    ...
    protected function validatorAlterarSenha(array $data)
    {
        return Validator::make($data, [
            'atualpass' => ['required', 'string'],
            'password' => ['required', 'string', 'min:4', 'confirmed'],
        ], [
            'atualpass.required' => 'O campo Senha Atual é obrigatório.',
