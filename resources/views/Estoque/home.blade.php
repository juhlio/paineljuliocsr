...
<div class="row">
    ...
    <div class="col-md-4">
        <x-adminlte-small-box title="Planilha" text="Baixar planilha com dados atuais do estoque"
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <x-adminlte-small-box title="R$ {{$totalEmEstoque}}" text="Custo Total do Estoque"
        theme="purple"    />

    </div>

    <div class="col-md-4">
        <x-adminlte-small-box title="{{$totalProdutosEstoque}}" text="Total de Produtos"
        theme="purple"   />
    </div>
