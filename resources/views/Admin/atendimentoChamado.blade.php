...
@section('title', ' Atendimento Emergencial')

@section('content_header')
<h1>Atendimento de Emergencia </h1>
@endsection
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="card p-3 mb-3">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md">
                    <strong> Cliente: </strong> {{$callData->name}} <br>
                    <strong> Solicitante: </strong> {{$callData->contactName}} <br>
                    <strong> Cargo: </strong> {{$callData->position}} <br>
                    <strong> Telefone: </strong> {{$callData->phone}} <br>
                </div>
        ...
        <div class="row">
            <strong class="mr-2"> Descrição do Problema: </strong>
        ...
        <div class="row">
            <div class="col-md">
                <x-adminlte-textarea name="tecAvaliation" label="Analise Técnica" />
            </div>
        ...
        <div class="row">
            <div class="col-md">
                <x-adminlte-textarea name="serviceExecuted" label="Serviço Executado" />
            </div>
